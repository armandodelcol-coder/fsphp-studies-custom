...
if ($postArray) {
    if (in_array("", $postArray)) {
        ...
        echo "<p class='trigger warning'>E-mail informado é inválido!</p>";
    } else {
        // array_map funciona com um callback, vc determina a função no primeiro
        // parâmetro e irá executar essa função para cada item do array (2º parâmetro)
