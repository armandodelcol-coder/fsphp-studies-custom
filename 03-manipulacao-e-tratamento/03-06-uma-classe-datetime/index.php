...
$dateBirth = new DateTime("1994-08-17");
...
$birth = new DateTime(date("Y") . "-08-17");
...
if ($diff->invert) {
    echo "<p>Seu aniversário foi a {$diff->days} dias";
} else {
    echo "<p>Faltam {$diff->days} dias para o seu aniversário";
}

$dateResources = new DateTime("now");
var_dump([
    $dateResources->format(DATE_BR),
    $dateResources->sub(DateInterval::createFromDateString("8days"))->format(DATE_BR),
