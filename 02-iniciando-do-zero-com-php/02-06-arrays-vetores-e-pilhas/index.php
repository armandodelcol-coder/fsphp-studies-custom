...
/**
 * Cria valores e ele automáticamente indexa os valores dentro da lista
 */
...
/**
 * Quem define qual é o key para acessar o valor, sou eu
 */
$arrayAssoc = [
    "vocal" => "Brian",
    "solo_guitar" => "Angus",
...
echo "<p>O vocal da banda AC/DC é {$acdc["vocal"]} 
    e junto com {$acdc["solo_guitar"]} fazem um show de rock.
";
